...
def create_board_frame(corners_by_cell):
    ...
    draw.rounded_rectangle((left, top, right, bottom), radius=22, fill=(5, 12, 18, 218), outline=(54, 77, 86, 170), width=3)
    split_x = (corners_by_cell[(0, 2)][1][0] + corners_by_cell[(0, 3)][0][0]) * 0.5
    draw.line((split_x, top + 6, split_x, bottom - 6), fill=(38, 82, 116, 210), width=4)
